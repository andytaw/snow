(function(){
    ...
    var style = '.flake{color: #444;position:fixed;top:-10%;animation-name: fall;animation-timing-function: linear;animation-iteration-count: infinite;z-index:999999;}.flake:after{content:\'*\'}.flake-1{font-size:6px;animation-duration: 20s;}.flake-2{font-size:12px;animation-duration: 15s;}.flake-3{font-size:24px;animation-duration: 10s;}.ground{background: #fff;position:fixed;left:0;bottom:0;width:100%;height:0;animation-name: lay;animation-duration: 300s;animation-delay: 10s;z-index:999999;}@keyframes fall {100% {color: #fff;top:110%;}}@keyframes lay {100% {height:100%;}}';
